...
def turn():
    ...
    if figura == 7:
        ...
        if matrix[q[1][0]][q[1][1]] == matrix[q[2][0]][q[2][1]] == matrix[q[3][0]][q[3][1]]:
            x, y = q[2][0], q[2][1]
            if matrix[x + 1][y] == 0:
                matrix[q[1][0]][q[1][1]] = 0
                matrix[x + 1][y] = 70
                ...
                if matrix[x + 2][y] == 0 == matrix[x - 1][y + 1]:
                    ...
                    matrix[x - 1][y] = 70
                    matrix[x][y + 1] = 70
        elif matrix[q[0][0]][q[0][1]] == matrix[q[1][0]][q[1][1]] == matrix[q[3][0]][q[3][1]]:
            x, y = q[1][0], q[1][1]
            print(x, y)
            if y != 0:
                if matrix[x][y - 1] == 0:
                    ...
                    if matrix[x - 1][y + 1] == 0 and matrix[x][y + 2] == 0:
                        ...
                        matrix[x][y - 1] = 70
                        matrix[x][y + 1] = 70
        elif matrix[q[1][0]][q[1][1]] == matrix[q[2][0]][q[2][1]] == matrix[q[0][0]][q[0][1]]:
            x, y = q[1][0], q[1][1]
            if matrix[x-1][y] == 0:
                matrix[x][y + 1] = 0
                matrix[x-1][y] = 70
        elif matrix[q[3][0]][q[3][1]] == matrix[q[2][0]][q[2][1]] == matrix[q[0][0]][q[0][1]]:
            x, y = q[2][0], q[2][1]
            if y != 9:
                if matrix[x][y + 1] == 0:
                    matrix[x][y + 1] = 70
