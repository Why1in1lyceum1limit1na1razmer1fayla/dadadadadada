    ...
    def render(self, screen):
        for y in range(self.h):
            for x in range(self.w):
                pygame.draw.rect(screen, (123, 123, 123),
...
pic1 = pygame.image.load('img/cats/1.png')
pic1.set_colorkey((255, 255, 255))
pic2 = pygame.image.load('img/cats/2.png')
pic2.set_colorkey((255, 255, 255))
pic3 = pygame.image.load('img/cats/3.png')
pic3.set_colorkey((255, 255, 255))

pic4 = pygame.image.load('img/cats/4.png')
pic4.set_colorkey((255, 255, 255))
pic5 = pygame.image.load('img/cats/5.png')
pic5.set_colorkey((255, 255, 255))
pic6 = pygame.image.load('img/cats/6.png')
pic6.set_colorkey((255, 255, 255))
pic7 = pygame.image.load('img/cats/7.png')
